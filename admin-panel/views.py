...
def broadcast() -> str:
    ...
    if request.method == "POST":
        ...
        if response.status_code == 200:
            ...
            return render_template("broadcast.html", page_title="Рассылка", response=response)
...
def settings() -> str:
    ...
    Returns:
        str: отрендеренная веб-страница с POST-запросом на базу данных.
    """
    users = ["s.i.birvert@utmn.ru", "e.y.markhel@utmn.ru", "s.v.aleksandrova@utmn.ru",
             "v.a.vunsh@utmn.ru", "o.v.loginova@utmn.ru", "e.a.mukhina@utmn.ru", "o.v.fedorina@utmn.ru"]
