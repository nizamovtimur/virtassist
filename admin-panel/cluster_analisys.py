...
class ClusterAnalisys():
    ...
    def __init__(self) -> None:
        ...
        # self.rake = Rake(language_code='ru')
    ...
    def preprocessing(self):
        ...
        def found_trash_words(words):
            ...
            SpecWords = ["тюмгу", "шкн", "игип", "фэи", "соцгум", "ипип", "биофак", "инзем", "инхим", "фти", "инбио",
                         "ифк", "ед", "шпи"]  # временный костыль для нахождения абривиатур ТюмГУ
            z = ('.', ',', '!', '?')  # набор пунктуации
    ...
    def vectorize(self):
        ...
        self.vectors = pd.DataFrame(X.toarray().transpose(), self.vectorizer.get_feature_names_out())
        self.scaler.fit(self.vectors)
        self.vectors = self.scaler.transform(self.vectors).transpose()


    def clustersing(self):
        ...
        klasters_HKA = HKA(self.vectors)
        self.clusters = otchet_IKA(klasters_HKA, self.df)
