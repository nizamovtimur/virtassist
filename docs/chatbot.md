 ...
 * работы чат-ботов VK и Telegram (LongPoll API)
 * предоставления справочной информации из структуры пространства вики-системы
 * ответов на произвольные вопросы студентов с возможностью оценивания
 * накопления данных о пользователях и вопросах
