 ...
 * предоставления справочной информации из структуры пространства вики-системы
 * работы чат-ботов ВКонтакте и Telegram на основе обработчиков событий
 * накопления в БД данных о пользователях и вопросах виртуальному помощнику с ответами на них
...
Обработчик события (для чат-бота ВКонтакте), при котором пользователь задаётвопрос чат-боту
